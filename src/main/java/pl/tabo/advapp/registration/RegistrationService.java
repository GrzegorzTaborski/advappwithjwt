    ...
    public ResponseEntity<?> register(RegistrationRequest request) throws Exception {
        ...
        if (!isValidEmail) {
            return ResponseEntity
                    .badRequest()
                    .body(new MessageResponse("Error: Email not valid!!"));
        }
        String token = null;
        try {
        ...
        return ResponseEntity
                .ok()
                .body(new MessageResponse("Confirm your account via email"));
    }

    @Transactional
    public ResponseEntity<?> confirmToken(String token) throws Exception {
